...
// PublicationMarketDocument was generated 2024-02-29 09:51:33.
type PublicationMarketDocument struct {
	XMLName                     xml.Name `xml:"Publication_MarketDocument"`
	Text                        string   `xml:",chardata"`
	Xmlns                       string   `xml:"xmlns,attr"`
	MRID                        string   `xml:"mRID"`           // 94d37fdea6a5400ca2f47a439...
	...
	CreatedDateTime                         string `xml:"createdDateTime"`                            // 2024-02-29T08:43:11Z, 202...
...
// CriticalNetworkElementMarketDocument was generated 2024-02-29 09:51:33.
type CriticalNetworkElementMarketDocument struct {
	XMLName                                 xml.Name `xml:"CriticalNetworkElement_MarketDocument"`
	Text                                    string   `xml:",chardata"`
	Xmlns                                   string   `xml:"xmlns,attr"`
	MRID                                    string   `xml:"mRID"`                                       // 46d6d17c423341bbac0d4e236...
	...
	CreatedDateTime                         string   `xml:"createdDateTime"`                            // 2024-02-29T08:43:47Z
...
// BalancingMarketDocument was generated 2024-02-29 09:51:34.
type BalancingMarketDocument struct {
	XMLName                     xml.Name `xml:"Balancing_MarketDocument"`
	Text                        string   `xml:",chardata"`
	Xmlns                       string   `xml:"xmlns,attr"`
	MRID                        string   `xml:"mRID"`                // 9b725a7e6fed4ffdae142ba15...
	RevisionNumber              string   `xml:"revisionNumber"`      // 1, 1, 1, 1, 1, 1, 1, 1, 1...
	...
	ReceiverMarketParticipantMarketRoleType string `xml:"receiver_MarketParticipant.marketRole.type"` // A33, A33, A33, A33, A33, ...
	CreatedDateTime                         string `xml:"createdDateTime"`                            // 2024-02-29T08:45:40Z, 202...
	...
	TimeSeries []struct {
		...
		FlowDirectionDirection  string `xml:"flowDirection.direction"`    // A02, A02, A01, A01, A02, ...
		...
		Period                  struct {
			...
			Point      []struct {
				...
				SecondaryQuantity      string `xml:"secondaryQuantity"`        // 0, 0, 27, 12, 0, 0, 0, 0,...
...
// UnavailabilityMarketDocument was generated 2024-02-29 09:51:34.
...
// GLMarketDocument was generated 2024-02-29 09:51:35.
type GLMarketDocument struct {
	XMLName                     xml.Name `xml:"GL_MarketDocument"`
	Text                        string   `xml:",chardata"`
	Xmlns                       string   `xml:"xmlns,attr"`
	MRID                        string   `xml:"mRID"`                // 6f4a9bf5cc9645d4987eb5194...
	RevisionNumber              string   `xml:"revisionNumber"`      // 1, 1, 1, 1, 1, 1, 1, 1, 1...
	...
	ReceiverMarketParticipantMarketRoleType string `xml:"receiver_MarketParticipant.marketRole.type"` // A33, A33, A33, A33, A33, ...
	CreatedDateTime                         string `xml:"createdDateTime"`                            // 2024-02-29T08:42:32Z, 202...
	TimePeriodTimeInterval                  struct {
		Text  string `xml:",chardata"`
		Start string `xml:"start"` // 2015-12-31T23:00Z, 2015-1...
		End   string `xml:"end"`   // 2016-12-31T23:00Z, 2016-1...
...
// AcknowledgementMarketDocument was generated 2024-02-29 09:51:35.
type AcknowledgementMarketDocument struct {
	XMLName                     xml.Name `xml:"Acknowledgement_MarketDocument"`
	Text                        string   `xml:",chardata"`
	Xmlns                       string   `xml:"xmlns,attr"`
	MRID                        string   `xml:"mRID"`            // 80ca5e96-a06f-4, a23f823e...
	CreatedDateTime             string   `xml:"createdDateTime"` // 2024-02-29T08:42:48Z, 202...
	SenderMarketParticipantMRID struct {
		Text         string `xml:",chardata"` // 10X1001A1001A450, 10X1001...
		CodingScheme string `xml:"codingScheme,attr"`
	} `xml:"sender_MarketParticipant.mRID"`
	...
	ReceivedMarketDocumentCreatedDateTime   string `xml:"received_MarketDocument.createdDateTime"`    // 2024-02-29T08:42:48Z, 202...
	Reason                                  struct {
